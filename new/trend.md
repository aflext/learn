...
讲了一些js的新东西，如webComponents、JIT、数据绑定、treeShaking(据说这玩意很火)
...
### typeScripts
- [Nest - Node.js framework built on top of TypeScript](https://kamilmysliwiec.com/nest-final-release-is-here-node-js-framework-built-top-of-typescript)
